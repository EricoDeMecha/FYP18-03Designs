...
\begin{itemize}
    ...
    Components such as strain-type load cells goes for Ksh. 250 a piece in Kenya. A temporary good deal was found on AliExpress, that reduced the price by half. The same case applied to the MCU board with the LCD.
    \item \textbf{Fabrication cost}\\
    The fabrication cost indicated in the budget is the maximum possible estimate.
\end{itemize}
