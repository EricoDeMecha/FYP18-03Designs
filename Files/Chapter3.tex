...
\end{enumerate}
Based on the above descriptions, the LA-T8 micro-linear actuator was selected for this application mainly because of its availability.
\par
...
\begin{enumerate}
    ...
    \item \textbf{Link}
    \par
    The link serves to connect the linear actuator to the flap. The design is such that, on one side it hinges onto the end of the 100mm actuator while on the other side it is attached to the flap. The linear(forward and backward) movement of the actuator moves the flap to either to direct the discharge into the main reservoir or into the collection tank.
    \begin{figure}[H]
        \centering
