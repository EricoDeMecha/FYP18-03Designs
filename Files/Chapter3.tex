...
\begin{enumerate}
    ...
    \par
    Using the MechDesigner software, the kinematic chain is designed to provide the required motion for the flap. The CAM data from its simulation are exported automatically to a SolidWorks model of the fixed point of the part.
    \begin{enumerate}
        \item \textbf{Crank}
        \par
